...
export const CertificateTemplate: React.FC<CertificateTemplateProps> = ({
  ...
  const sig1Name = safeData.signature1Name || "Alex Mercer";
  const sig1Title = safeData.signature1Title || "COMMUNITY LEAD";
  
  const sig2Name = safeData.signature2Name || "Jordan Lee";
    ...
    >
      ...
      <div className="absolute top-[40px] left-[48px] right-[48px] z-20 flex justify-between items-start">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-[28px] tracking-tight text-[#0B2046] leading-none">CredLedger</div>
