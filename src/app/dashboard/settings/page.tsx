...
import { Save, Moon, User, Palette } from 'lucide-react';
  ...
  return (
    <div className="p-4 md:p-8 bg-surface-bright min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 border-b-2 border-pure-black pb-4">
          <h1 className="font-playfair text-[48px] leading-none text-pure-black font-bold tracking-tight mb-2">Profile Settings</h1>
        ...
        <div className="bg-pure-white border-2 border-pure-black border-b-8 border-r-8 shadow-sm p-8">
          <div className="flex items-center gap-3 mb-6 border-b border-outline-variant pb-4">
            ...
            <h2 className="font-dot text-[18px] uppercase tracking-wider text-pure-black">Profile Details</h2>
          </div>
        ...
        <div className="bg-pure-white border-2 border-pure-black border-b-8 border-r-8 shadow-sm p-8 mt-8">
          <div className="flex items-center gap-3 mb-6 border-b border-outline-variant pb-4">
            <Palette className="w-6 h-6 text-primary" />
            <h2 className="font-dot text-[18px] uppercase tracking-wider text-pure-black">Appearance</h2>
          </div>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-hanken text-pure-black text-sm font-semibold">Theme Mode</p>
              <p className="font-hanken text-on-surface-variant text-xs mt-1">Switch between dark and light mode for the dashboard.</p>
            </div>
            <div className="border border-outline-variant rounded-full bg-surface-bright">
              <ThemeToggle />
            </div>
          </div>
        </div>
